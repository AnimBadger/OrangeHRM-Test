...
export class WorkShiftsPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.addHeader = page.locator('h6:has-text("Add Work Shift")');
    this.editHeader = page.locator('h6:has-text("Edit Work Shift")');
  ...
  async clickAdd(): Promise<void> {
    logger.info('Clicking Add button on work shifts page');
  ...
  async clickEdit(rowIndex: number): Promise<void> {
    logger.info(`Editing work shift at row ${rowIndex}`);
