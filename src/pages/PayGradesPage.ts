...
export class PayGradesPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.addHeader = page.locator('h6:has-text("Add Pay Grade")');
    this.editHeader = page.locator('h6:has-text("Edit Pay Grade")');
  ...
  async clickAdd(): Promise<void> {
    logger.info('Clicking Add button on pay grades page');
  ...
  async clickEdit(rowIndex: number): Promise<void> {
    logger.info(`Editing pay grade at row ${rowIndex}`);
