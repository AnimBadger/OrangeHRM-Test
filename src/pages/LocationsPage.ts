...
export class LocationsPage extends BasePage {
  ...
  readonly formCountryDropdown: Locator;
  ...
  constructor(page: Page) {
    ...
    this.formCountryDropdown = this.form.locator('.oxd-select-wrapper').first();
    ...
    this.addHeader = page.locator('h6:has-text("Add Location")');
    this.editHeader = page.locator('h6:has-text("Edit Location")');
  ...
  async clickEdit(rowIndex: number): Promise<void> {
    logger.info(`Editing location at row ${rowIndex}`);
